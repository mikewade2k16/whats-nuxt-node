...
const {
  ...
  getStatusLabel,
  onCloseConversation
} = defineProps(["activeConversation","activeConversationLabel","userRole","canManageConversation","getInitials","getChannelLabel","getStatusColor","getStatusLabel","onCloseConversation"]);
</script>
