...
<template>
  <FilaAtendimentoPageShell workspace-id="multiloja" title="Multi-loja" description="Comparativo consolidado de performance, metas e governanca das lojas do modulo no shell administrativo.">
    <MultiStoreWorkspace
      :state="state"
