...
<template>
  <div class="workspace__intro" style="display: none;">
    ...
    <p class="workspace__text">
      Acompanhamento da fila, do atendimento ativo e das acoes operacionais da loja.
    </p>
  </div>
      ...
      <div class="queue-column__body queue-column__body--waiting">
        ...
        <div v-else class="queue-empty">
          ...
          <span class="queue-empty__text">
            {{ readOnly ? 'Acompanhe por aqui quando a operacao da loja iniciar novos atendimentos.' : 'Use a barra de Consultores abaixo para colocar alguem na lista.' }}
          </span>
        </div>
      </div>
    </section>
