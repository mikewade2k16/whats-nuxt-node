...
const props = withDefaults(defineProps<{
  ...
  subtitle: "Visao central dos arquivos `.md` com checklist de progresso para acompanhar entrega tecnica."
});
  ...
  <div class="docs-page">
    <header class="docs-page__header">
      ...
      <div class="docs-page__actions">
        <UButton v-if="!props.embedded" to="/admin/omnichannel/inbox" color="neutral" variant="outline">Inbox</UButton>
        <UButton v-if="!props.embedded" to="/admin/manage/auditoria" color="neutral" variant="outline">Auditoria</UButton>
