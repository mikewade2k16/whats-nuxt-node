    ...
    <div ref="containerRef" class="product-pick">
      <div class="product-pick__inline-row">
        ...
        <button
          ...
          @click="toggleNone"
        >
          <AppMaterialIcon name="do_not_disturb_on" />
        </button>
        ...
        >
          ...
          >
            <AppMaterialIcon :name="hasItemDetail(item.id) ? 'edit_note' : 'note_add'" />
          </button>
          <button
            type="button"
        ...
        >
          <AppMaterialIcon :name="hasSharedDetail ? 'edit_note' : 'note_add'" />
        </button>
      </div>
      ...
      <Teleport to="body">
        <template v-if="dropdownOpen">
          ...
          >
            ...
            >
              <AppMaterialIcon name="add_circle" />
