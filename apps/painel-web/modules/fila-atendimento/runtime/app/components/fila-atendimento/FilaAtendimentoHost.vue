              ...
              >
                <div class="fila-queue-card__lead">
                  ...
                  <span class="fila-queue-card__avatar" :style="{ '--avatar-accent': person.color || '#38bdf8' }">
                    <img v-if="person.avatarUrl" class="fila-queue-card__avatar-img" :src="person.avatarUrl" :alt="person.name">
                    <template v-else>{{ person.initials || person.name?.slice(0, 2) }}</template>
                  </span>
                </div>
            ...
            >
              <div class="fila-roster-card__identity">
                <span class="fila-roster-card__avatar" :style="{ '--avatar-accent': consultant.color || '#38bdf8' }">
                  <img v-if="consultant.avatarUrl" class="fila-roster-card__avatar-img" :src="consultant.avatarUrl" :alt="consultant.name">
                  <template v-else>{{ consultant.initials || consultant.name?.slice(0, 2) }}</template>
                </span>
...
.fila-queue-card__avatar-img,
.fila-roster-card__avatar-img {
  width: 100%;
  height: 100%;
  display: block;
