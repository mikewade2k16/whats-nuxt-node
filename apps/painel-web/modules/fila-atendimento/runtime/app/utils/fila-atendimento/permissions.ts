...
const ROLE_WORKSPACES: Record<string, string[]> = {
  platform_admin: ['operacao', 'consultor', 'ranking', 'dados', 'inteligencia', 'relatorios', 'metricas', 'campanhas', 'multiloja', 'configuracoes'],
  owner: ['operacao', 'consultor', 'ranking', 'dados', 'inteligencia', 'relatorios', 'metricas', 'campanhas', 'multiloja', 'configuracoes'],
  marketing: ['dados', 'inteligencia', 'relatorios', 'campanhas', 'multiloja'],
  manager: ['operacao', 'consultor', 'ranking', 'dados', 'inteligencia', 'relatorios', 'metricas'],
  store_terminal: ['operacao'],
  consultant: ['operacao', 'consultor', 'dados'],
  admin: ['operacao', 'consultor', 'ranking', 'dados', 'inteligencia', 'relatorios', 'metricas', 'campanhas', 'multiloja', 'configuracoes']
}
...
export function canAccessOperations(role: unknown) {
  const normalized = normalizeAppRole(role)
