...
export const FILA_ATENDIMENTO_WORKSPACES: FilaAtendimentoWorkspace[] = [
  ...
  { id: 'consultor', label: 'Equipe', icon: 'groups', path: '/admin/fila-atendimento/consultor', supported: true },
  ...
  { id: 'metricas', label: 'Métricas', icon: 'query_stats', path: '/admin/fila-atendimento/metricas', supported: true },
