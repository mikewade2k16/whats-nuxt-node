...
export interface FilaAtendimentoOperationMutationConsultantStatus {
  personId?: string
  status?: FilaAtendimentoConsultantStatus
}

export interface FilaAtendimentoOperationMutationDelta {
  removeWaitingPersonId?: string
  removeActivePersonId?: string
  removePausedPersonId?: string
  waitingEntry?: Record<string, unknown> | null
  activeService?: Record<string, unknown> | null
  pausedEmployee?: Record<string, unknown> | null
  consultantStatus?: FilaAtendimentoOperationMutationConsultantStatus | null
  serviceHistoryEntry?: Record<string, unknown> | null
}

export interface FilaAtendimentoOperationCommandResult {
  ok: boolean
  message?: string
  delta?: FilaAtendimentoOperationMutationDelta | null
}
...
export interface FilaAtendimentoReportsStoreComparison {
  storeId?: string
  storeName?: string
  storeCode?: string
  totalAttendances?: number
...
export interface FilaAtendimentoReportsOverviewResponse {
  ...
  storeComparisons?: FilaAtendimentoReportsStoreComparison[]
}
...
export interface FilaAtendimentoWorkspaceBundle {
  storeId: string
  storeName?: string
  storeCode?: string
  consultants?: FilaAtendimentoConsultantView[]
  snapshot?: FilaAtendimentoSnapshotResponse | null
  reportResults?: FilaAtendimentoReportsResultItem[]
  settings?: FilaAtendimentoSettingsResponse | null
}
...
export interface FilaAtendimentoAnalyticsRankingStoreComparison {
  storeId?: string
  storeName?: string
  storeCode?: string
  monthlySoldValue?: number
...
export interface FilaAtendimentoAnalyticsRankingResponse {
  ...
  storeComparisons?: FilaAtendimentoAnalyticsRankingStoreComparison[]
}
...
export type FilaAtendimentoMetricEventStatus = 'ok' | 'warning' | 'error'

export interface FilaAtendimentoMetricEventInput {
  pageKey: string
  pagePath: string
  eventType: string
  eventKey: string
  storeId?: string
  status: FilaAtendimentoMetricEventStatus
...
export interface FilaAtendimentoMetricEvent extends FilaAtendimentoMetricEventInput {
  id: string
  tenantId?: string
  actorUserId?: string
  actorRole?: string
...
export interface FilaAtendimentoMetricAggregate {
  eventKey: string
  eventType: string
  total: number
  ok: number
...
export interface FilaAtendimentoActionCoverage {
  key: string
  label: string
  kind: string
  endpoint?: string
...
export interface FilaAtendimentoChecklistItem {
  key: string
  label: string
  status: string
  severity: string
...
export interface FilaAtendimentoMetricSummary {
  totalEvents: number
  okEvents: number
  errorEvents: number
  avgDurationMs: number
  ...
  slowEvents: number
  lastEventAt?: string
  aggregates: FilaAtendimentoMetricAggregate[]
  actionCoverage: FilaAtendimentoActionCoverage[]
  securityChecklist: FilaAtendimentoChecklistItem[]
  developmentSignals: FilaAtendimentoChecklistItem[]
}

export interface FilaAtendimentoMetricsResponse {
