...
function seedItems() {
  ...
  const base: ServerQaItem[] = [
    ...
    { id: 45, block: 'Atendimento Multi-tenant', sprint: 'Sprint 04', squad: 'Core', feature: 'Centralizar todo o auth do atendimento no platform-core', status: 'in_progress', priority: 'alta', source: 'novo', owner: 'Core', targetPage: '/admin/omnichannel/*', effort: 'L', notes: 'Fluxo principal ja centralizado no core; falta fechar remanescentes legados e expandir a validacao por instancia no multi-whats.', updatedAt: date },
    ...
    { id: 37, block: 'Operacao Marketing', sprint: 'Sprint 03', squad: 'Frontend', feature: 'Conectar paginas de Team com banco e integrações reais', status: 'todo', priority: 'media', source: 'novo', owner: 'Frontend', targetPage: '/admin/team/*', effort: 'L', notes: 'Treinamento, candidatos e fluxos relacionados precisam sair do mock.', updatedAt: date },
    ...
    { id: 1, block: 'Autenticacao e Acesso', sprint: 'Sprint 01', squad: 'Backend', feature: 'Login com MFA opcional', status: 'todo', priority: 'alta', source: 'novo', owner: 'Backend', targetPage: '/auth/login', effort: 'M', notes: 'Ativar por tenant/papel.', updatedAt: date },
