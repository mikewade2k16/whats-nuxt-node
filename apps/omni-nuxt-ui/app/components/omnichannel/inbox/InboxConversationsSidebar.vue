    ...
    <template #header>
      <div class="chat-page__header-row">
        ...
        <div class="chat-page__header-actions">
          ...
          <UButton v-if="!collapsedModel" to="/admin/omnichannel/docs" size="sm" color="neutral" variant="ghost">
            Docs
          </UButton>
          <UButton
            v-if="!collapsedModel && !isContactsView"
    ...
    <div class="chat-page__sidebar-content">
      ...
      <div v-if="!collapsedModel" class="chat-page__filters">
        ...
        <div v-if="!isContactsView && showFiltersModel" class="chat-page__filters-grid">
          ...
          <UFormField v-if="availableInstances.length > 1" label="Instancia" name="instanceId">
            <USelect v-model="instanceModel" :items="instanceFilterItems" value-key="value" />
          </UFormField>
        </div>
