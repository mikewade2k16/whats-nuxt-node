  ...
  <div class="docs-page">
    <header class="docs-page__header">
      ...
      <div class="docs-page__actions">
        <UButton to="/admin/omnichannel/inbox" color="neutral" variant="outline">Inbox</UButton>
        <UButton to="/admin/omnichannel/operacao" color="neutral" variant="outline">Admin</UButton>
