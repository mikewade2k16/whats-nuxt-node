    ...
    ?>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="content">
                    <h5><?= $loja ?></h5>
                    <p class="title">Reposição Café: <?= calcularNotaItemSimNao($reposicaoCafe, $pesoReposicaoCafe); ?>%</p>
                    <p class="title">Bolo, Bebidas e Comidas: <?= calcularNotaItemSimNao($boloBebidasComidas, $pesoBoloBebidasComidas); ?>%</p>
                    <p class="title">Embalagens: <?= calcularNotaItemSimNao($embalagens, $pesoEmbalagens); ?>%</p>
                    <p class="title">Mezanino: <?= calcularNotaItemSimNao($mezanino, $pesoMezanino); ?>%</p>
